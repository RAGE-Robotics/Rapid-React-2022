...
#define CLIMBER_FORWARD_BUTTON_1 9
...
#define EXTEND_CLIMBER_BRAKE_SOLENOID 3
#define RETRACT_CLIMBER_BRAKE_SOLENOID 5
...
#define SHOOTER_ANGLE_HOME_SPEED 0.3
